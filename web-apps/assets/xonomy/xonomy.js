	...
	if(!Xonomy.notclick) {
		...
		if(!isReadOnly && what=="text") {
			...
			if (typeof(spec.asker) != "function") {
				var content=Xonomy.askString(value, null, Xonomy.harvestElement($("#"+htmlID).closest(".element").toArray()[0])); //compose bubble content
			} else {
...
Xonomy.askTime=function(defaultString, askerParameter, jsMe) {
  var width=300;
	var html="";
	html+="<form onsubmit='Xonomy.answer(this.val.value); return false'>";
	  html+="<input type='time' name='val' class='textbox focusme' style='width: "+width+"px;' value='"+Xonomy.xmlEscape(defaultString)+"' onkeyup='Xonomy.notKeyUp=true'/>";
	  html+=" <input type='submit' value='OK'>";
	html+="</form>";
	return html;
};
...
Xonomy.askNumber=function(defaultString, askerParameter, jsMe) {
  var width=300;
	var html="";
	html+="<form onsubmit='Xonomy.answer(this.val.value); return false'>";
	  html+="<input type='number' name='val' class='textbox focusme' style='width: "+width+"px;' value='"+Xonomy.xmlEscape(defaultString)+"' onkeyup='Xonomy.notKeyUp=true'/>";
	  html+=" <input type='submit' value='OK'>";
	html+="</form>";
	return html;
};
