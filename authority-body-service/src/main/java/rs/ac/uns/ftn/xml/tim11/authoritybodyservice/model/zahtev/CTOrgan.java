...
@XmlType(name = "CTOrgan", namespace = "http://www.ftn.uns.ac.rs/xml/tim11/zahtev", propOrder = {
    "naziv",
    "sediste"
})
public class CTOrgan {
    ...
    @XmlElement(name = "Sediste", namespace = "http://www.ftn.uns.ac.rs/xml/tim11/zahtev", required = true)
